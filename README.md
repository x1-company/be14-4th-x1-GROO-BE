...
- **아쉬운 점**
  ...
  - 기획에 시간이 많이 소요되어 일부 기능은 구현하지 못해 아쉬움이 남는다.
...
- **앞으로의 개선 방향**
  ...
  -  모델링 부분에서 좀 더 적극적으로 참여하여, 데이터 정합성 및 효율을 고려한 모델링 설계를 주도해보고싶다.
